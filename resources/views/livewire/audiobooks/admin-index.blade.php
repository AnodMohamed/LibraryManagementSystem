        ...
        <table class="w-full divide-y divide-gray-200">
            ...
            <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                ...
                <tr>
                    ...
                    @php
                            $student = DB::table('users')->where('id',$audiobook->bookspeaker )->first();
                    @endphp
                    ...
                    <td class="px-2 py-4 whitespace-nowrap">
                        <livewire:buttons.audiobookfeatured :audiobook="$audiobook" :name="'featured'" :key="'featured'.$audiobook->id" />
                    </td>
