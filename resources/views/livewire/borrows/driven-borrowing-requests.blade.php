                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $driven->book->bcopiesInwarehouse }}
                                </td>
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    <div class="flex justify-start space-x-1">
                                        
                                        <a href="{{ route('AppointmentPage', $driven) }}" class="p-1 border-2 border-indigo-00 rounded-md bg-blue-300">
                                        ...
                                        <livewire:buttons.borrow-driven :driven="$driven" :key="$driven->id" />
