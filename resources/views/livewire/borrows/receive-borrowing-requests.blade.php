                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            ...
                            <tr>
                                ...
                                @php
                                     $receiveedtable = DB::table('reversions')->where('borrow_id',$receive->id )->first();
                                @endphp
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $receiveedtable->fine}}
                                </td>
                                ...
                                {{------
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $receive->reversion->received_date }}
                                </td>

                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $receive->reversion->fine }}
                                </td> 
                                ------}}
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    <div class="flex justify-start space-x-1">
                                        
                                        <a href="{{ route('AppointmentPage', $receive) }}" class="p-1 border-2 border-indigo-00 rounded-md bg-blue-300">
