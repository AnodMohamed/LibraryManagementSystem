        ...
        <table class="w-full divide-y divide-gray-200">
            ...
            <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                ...
                @foreach($unpaids as $unpaid)
                    @php
                        $transaction =  DB::table('transactions')->where('reversion_id',$unpaid->id)->first();
                    @endphp
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                            <div class="flex justify-start space-x-1">
                                ...
                                <a href="{{ route('payments.payment', $unpaid) }}" class="p-1 border-2 border-indigo-00 rounded-md bg-blue-300">
                                    pay
                                </a>
                            </div>
                        </td>
