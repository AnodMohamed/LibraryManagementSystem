                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="text-xs divide-y divide-gray-200 bg-indigo-50">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-4 whitespace-nowrap">
                                    <livewire:buttons.bookfeatured :book="$book" :name="'featured'" :key="'featured'.$book->id" />
                                </td>
                                <td class="px-2 py-4 whitespace-nowrap">
                                    {{ $book->edition }}
                                </td>
                                ...
                                <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                    <div class="flex justify-start space-x-1">
                                        ...
                                        <a href="{{ route('books.edit', $book) }}" class="p-1 border-2 border-indigo-200 rounded-md">
                                        ...
                                        <livewire:buttons.delete-book :book="$book" :key="$book->id" />
