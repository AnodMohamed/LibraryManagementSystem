<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Logo -->
                {{-- Logo --}}
                <a class="text-2xl font-bold text-black py-2 no-underline toggleColour hover:no-underline lg:text-4xl" href="{{ route('home') }}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('StudentDashboard.index') }}" :active="request()->routeIs('StudentDashboard.index')">
                {{ __('Dashboard') }}
