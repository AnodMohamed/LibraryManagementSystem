...
class PostController extends Controller
{
    ...
    {
        return view('StudentDashboard.posts.index');
    }
    ...
    {
        return view('StudentDashboard.posts.create', [
            'tags'          => Tag::all(),
    ...
    public function edit(Post $post)
    {
        ...
        return view('StudentDashboard.posts.edit', compact('post', 'tags', 'categories', 'oldTags'));
    }
